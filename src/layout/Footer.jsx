      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400">
            ...
            modernes et robustes avec Java, React, Angular, Python & Spring Boot.
          </p>
        </div>
        ...
        <div className="flex flex-col space-y-2 liens">
          ...
          <a href="/" className="hover:text-[var(--color-primary)] transition">Accueil</a>
          <a href="/about" className="hover:text-[var(--color-primary)] transition">À propos</a>
          <a href="/projects" className="hover:text-[var(--color-primary)] transition">Projets</a>
